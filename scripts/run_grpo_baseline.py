...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--config", type=str, default="configs/grpo_cloud_gpu_baseline.yaml")
...
def main() -> None:
    ...
    print("[run_grpo_baseline] loaded config:", args.config, flush=True)
    print("[run_grpo_baseline] model:", cfg.get("model_name"), flush=True)
    print("[run_grpo_baseline] output_dir:", cfg.get("output_dir"), flush=True)
    print("[run_grpo_baseline] max_steps:", cfg.get("max_steps"), flush=True)
    ...
    wrapper = FinPlanRewardWrapper(diagnostics_path=diagnostics_path, method="grpo")
